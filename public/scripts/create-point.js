// Função onde gera lista de estados
...
// Função onde pega as cidades dos estados
function getCities(event) {
    ...
    citySelect.innerHTML = "" //zerar array pra não acumular cidades
...
function handleSelectedItem(event) {
    ...
    // add ou remover uma classe/item com js
